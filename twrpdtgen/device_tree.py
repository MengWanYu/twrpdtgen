...
from twrpdtgen import version as version
...
"""
def init(self, image: Path, aik_path: Path = None):
...
LOGD(f"Using local AIK directory: {self.aik_manager.aik_path}")
...
self.render_template(device_tree_folder, "omni_device.mk", out_file=f"omni{self.device_info.codename}.mk")
